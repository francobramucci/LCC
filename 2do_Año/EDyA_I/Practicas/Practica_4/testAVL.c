...
int main() {
    ...
    AVL arbol2 = avl_crear(copiar_puntero_entero, comparar_puntero_entero, destruir_puntero_entero);
    ...
    avl_recorrer(arbol2, AVL_RECORRIDO_IN, imprimir_puntero_entero, NULL);
    puts("Ok");

    avl_eliminar(arbol2, numeros + 1); // eliminar 20
    avl_recorrer(arbol2, AVL_RECORRIDO_IN, imprimir_puntero_entero, NULL);
    ...
    AVL arbol3 = avl_crear(copiar_puntero_entero, comparar_puntero_entero, destruir_puntero_entero);
    avl_insertar(arbol3, numeros + 2); // 15
    avl_insertar(arbol3, numeros);     // 10
    avl_insertar(arbol3, numeros + 1); // 20

    avl_eliminar(arbol3, numeros + 2); // eliminar 15

    avl_recorrer(arbol3, AVL_RECORRIDO_IN, imprimir_puntero_entero, NULL);
    puts("Ok");
